...
const paragrafoDiasValidos = document.getElementById(
  "paragrafo__dias__validos"
);
...
function limparCampos() {
  ...
  outputDiasValidos.innerText = "";
  paragrafoAssiduidade.classList.toggle("ocultar");
  paragrafoDiasValidos.classList.toggle("ocultar");
